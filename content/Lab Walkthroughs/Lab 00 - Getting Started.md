# Summary
In this lab we are just learning how to navigate the tool **WifiForge**. WifiForge is a framework built on top of the open source software [Mininet-WiFi](https://mininet-wifi.github.io) that provides *wireless* wifi labs! The labs in this course teach a variety of common wifi hacking concepts. 
...
![[00-terminal.png]]
*Ignore any older commands that may appear in the terminal - these are just for housekeeping.*
