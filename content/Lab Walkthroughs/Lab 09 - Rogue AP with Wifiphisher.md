---
title: Lab 09 - Rogue AP with Wifiphisher
---

**Estimated Time:** ~30-35 minutes  

## Summary
Create sophisticated rogue access points using Wifiphisher to deploy phishing attacks and harvest user credentials.

Select "Wifiphisher" from the menu. Allow up to 30 seconds to initialize the network. 

![WifiForge main menu with Wifiphisher option](images/lab-09/09-main-menu.png)
...
![Split terminal view with Attacker and host1 panes](images/lab-09/09-terminals.png)
...
![Wifiphisher help menu showing available options](images/lab-09/09-help.png)
...
![Wifiphisher operator console showing active attack status](images/lab-09/09-wifiphisher.png)

As it runs, note that wifiphisher is creating additional fake networks with names such as FREE WIFI, HOTEL, etc. 

![Wifiphisher beacon display showing multiple fake networks](images/lab-09/09-beacons.png)
...
![Network scan results showing available networks from victim perspective](images/lab-09/09-networks.png)
...
![Wifiphisher showing successful victim connection to evil twin](images/lab-09/09-evil-twin.png)
...
![Firefox Profile Manager selection screen](images/lab-09/09-firefox-profile.png)

Navigate to the IP address 10.0.0.1.

![Browser navigation to phishing portal](images/lab-09/09-browser-navigation.png)
...
![Fake WiFi login page with password field](images/lab-09/09-fake-login-page.png)


The password you entered will appear in the attacker console under the HTTP requests panel. 

![Captured credentials displayed in attacker console](images/lab-09/09-captured-credentials.png)

Use the `main_menu` command to return to the main menu and onto the next lab. 

## Lab Complete
Congratulations! You have successfully completed Lab 09. You now understand:
- Creating convincing rogue access points with Wifiphisher
- Deploying captive portal phishing attacks
- Social engineering through fake wireless networks
- Credential harvesting from unsuspecting users
- Multi-perspective attack analysis and monitoring

---
**PREVIOUS LAB:** [Lab 08 - Cracking NETNTLM Credentials with John the Ripper](Lab%2008%20-%20Cracking%20NETNTLM%20Credentials%20with%20John%20the%20Ripper.md)  
**NEXT LAB:** [Lab 10 - WPS Exploitation](Lab%2010%20-%20WPS%20Exploitation.md)
